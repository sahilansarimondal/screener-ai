...
const rows = [
  {
    label: "Revenue",
    values: [
      37274, 40930, 45002, 47548, 51168, 75039, 78008, 79434, 81546, 83002,
      85040, 86779, 87372,
    ],
  },
  {
  ...
  { label: "Gross NPA %", values: [] },
  { label: "Net NPA %", values: [] },
];
export default function QuarterlyResultsTable() {
  return (
    <Card id="quarters" className="overflow-auto rounded-2xl ">
      <CardHeader className="pb-2">
        <CardTitle className="text-xl">Quarterly Results</CardTitle>
